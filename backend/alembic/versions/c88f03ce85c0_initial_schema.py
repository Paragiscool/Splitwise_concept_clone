...
Revision ID: c88f03ce85c0
Revises: 
Create Date: 2026-06-01 17:44:06.842752
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_group_balances_id'), 'group_balances', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_group_balances_id'), table_name='group_balances')
